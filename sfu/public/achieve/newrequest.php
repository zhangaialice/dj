...
<div id="chart1" style="height: 500px; width: 30%;"></div>
<div id="chart2" style="height: 500px; width: 30%;"></div>
<div id="chart3" style="height: 500px; width: 30%;"></div>
				...
				?>
				  <tr>
					<td><?php echo $row[$value[2]];
					     ${$value[0].'_'.$value[3].'_'.$value[2]}[]=$row[$value[2]];?></td>
...
<?php } ?>
				...
				<?php print_r($Endowment_2016_Managers); ?><br/>
				<?php
...
<!-- The above the generate all 12 tables(endowment*3,manager*2,year*2 and all 36 array(endowment*3,manager*2, year*2, CanadianEquity*3), below is to generate jchart using the table above-->
	...
	$cl_CE_D_Endowment_2016_Managers =array();
	foreach (array_combine($Endowment_2016_Managers,$CE_D_Endowment_2016_Managers) as $label => $value)
	{$cl_CE_D_Endowment_2016_Managers[]= array("y"=>$value,"label"=>$label);}
	
	$cl_CE_D_Endowment_2015_Managers =array();
	foreach (array_combine($Endowment_2015_Managers,$CE_D_Endowment_2015_Managers) as $label => $value)
	{$cl_CE_D_Endowment_2015_Managers[]= array("y"=>$value,"label"=>$label);}	
	
	$cl_GE_D_Endowment_2016_Managers=array();
	foreach (array_combine($Endowment_2016_Managers,$GE_D_Endowment_2016_Managers) as $label => $value)
	{$cl_GE_D_Endowment_2016_Managers[]= array("y"=>$value,"label"=>$label);}
	
	$cl_GE_D_Endowment_2015_Managers =array();
	foreach (array_combine($Endowment_2015_Managers,$GE_D_Endowment_2015_Managers) as $label => $value)
	{$cl_GE_D_Endowment_2015_Managers[]= array("y"=>$value,"label"=>$label);}	
	
	$cl_TE_D_Endowment_2016_Managers =array();
	foreach (array_combine($Endowment_2016_Managers,$TE_D_Endowment_2016_Managers) as $label => $value)
	{$cl_TE_D_Endowment_2016_Managers[]= array("y"=>$value,"label"=>$label);}
	
	$cl_TE_D_Endowment_2016_Managers =array();
	foreach (array_combine($Endowment_2015_Managers,$TE_D_Endowment_2015_Managers) as $label => $value)
	{$cl_TE_D_Endowment_2015_Managers[]= array("y"=>$value,"label"=>$label);}	
	?> ";
	alert(result);
	return false;
	}
	...
	var CE_D_Endowment_2016_Managers = <?php echo json_encode($cl_CE_D_Endowment_2016_Managers, JSON_NUMERIC_CHECK); ?>// data change
	var CE_D_Endowment_2015_Managers =<?php  echo json_encode($cl_CE_D_Endowment_2015_Managers, JSON_NUMERIC_CHECK); ?>//data change
	var GE_D_Endowment_2016_Managers = <?php  echo json_encode($cl_GE_D_Endowment_2016_Managers, JSON_NUMERIC_CHECK); ?>// data change
	var GE_D_Endowment_2015_Managers =<?php  echo json_encode($cl_GE_D_Endowment_2015_Managers, JSON_NUMERIC_CHECK); ?>//data change
	var TE_D_Endowment_2016_Managers = <?php  echo json_encode($cl_TE_D_Endowment_2016_Managers, JSON_NUMERIC_CHECK); ?>// data change
	var TE_D_Endowment_2015_Managers =<?php  echo json_encode($cl_TE_D_Endowment_2015_Managers, JSON_NUMERIC_CHECK); ?>

	<?php $looplist =[["CE_D_Endowment_2016_Managers","CE_D_Endowment_2015_Managers","chart1"],
	["GE_D_Endowment_2016_Managers","GE_D_Endowment_2015_Managers","chart2"],
	["TE_D_Endowment_2016_Managers","TE_D_Endowment_2015_Managers","chart3"]];

	?>
	
	<?php foreach($looplist as $a){ ?>
	
	window.onload = function () {
    var chart = new CanvasJS.Chart($a[2],//-div name change
    {
      title:{
      ...
      {        
        ...
        color: "gold",
		dataPoints: $a[0]
        //dataPoints: CE_D_Endowment_2016_Managers
	  ...
	  {        
        ...
        color: "silver",
		dataPoints: $a[1]
        //dataPoints: CE_D_Endowment_2015_Managers
