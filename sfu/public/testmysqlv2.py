...
query = ("SELECT * FROM holding WHERE Year = 2016")
...
str_a = 'FossilFuel_2016'
str_b = 'Total_2016'
str_perc='Percentage_2016'
...
df_three_index=df_three.to_json(orient='index')
df_three_split=df_three.to_json(orient='split')
# df_three_table=df_three.to_json(orient='table')
df_three_records=df_three.to_json(orient='records')
df_three_columns=df_three.to_json(orient='columns')
df_three_values=df_three.to_json(orient='values')




dict_three_values=json.loads(df_three_values)
dict_three_index=json.loads(df_three_index)
dict_three_split=json.loads(df_three_split)

test_ai ={"index": dict_three_index,"split":dict_three_split,"values": dict_three_values}
print type(test_ai)


test2= json.dumps(test_ai)

# print df_three.head(10)
# print df_three_index,'\n', '\n',df_three_split, '\n','\n',df_three_records,'\n','\n',df_three_columns,'\n','\n',df_three_values,'\n'

# import json
# print test=json.dumps(df_three_json)
cursor.close()
...
# savefile.write(test)
# savefile.write(df_three_values)
# savefile.write(df_three_split)
# savefile.write(df_three_columns)
# savefile.write(df_three_records)
# savefile.write(df_three_index)
...
# # postData = {'results':bulkData}
# conn.request("POST", "pythonphp.php", postData, headers)
