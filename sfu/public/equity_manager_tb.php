...
<a href="equity_manager_modal.php">chart view</a>
<div id="content">
...
foreach ($loop_value as $value) { 
			...
			$var = $sort.'Managers_2016';
			$var1= $value.$sort.'Managers_2016';
			$var2= $value.$sort.'Managers_2015';
...
<?php 
	 ...
	 echo"<th>2016_CE($)</th>";
	 echo"<th>2016_CE($)</th>";
    for ($i=0; $i < count($Endowment_Managers_2016); $i++) 
    { 
    echo "<tr>"; 

        echo "<td>$Endowment_Managers_2016[$i]</td>"; 
		echo "<td>$CE_D_Endowment_Managers_2016[$i]</td>"; 
        echo "<td>$CE_D_Endowment_Managers_2015[$i]</td>";
    echo "</tr>"; 
    } 
